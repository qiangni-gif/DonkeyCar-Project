var driveHandler = new function() {
    ...
    this.load = function() {
      ...
      socket.onmessage = function (event) {
          console.log(event.data); // recive msg from web.py
          state.current_charging_state = JSON.parse(event.data).current_charging_state
          console.log(state.current_charging_state)
      };
    ...
    var setBindings = function() {
      ...
      $('#Charging_button').click(function () {
        toggleCharging();
      });
    ...
    var updateUI = function() {
      ...
      ////
      console.log("at updateUI")

      if (state.current_charging_state && state.charging_state){
        $('#Charging_button')
        .html('Charging pad is On')
        .removeClass('btn-Success')
        .removeClass('btn-warning')
        .addClass('btn-info').end()
      }
      else if(!state.current_charging_state && state.charging_state){
        $('#Charging_button')
        .html('Charging is turning On')
    ...
    var toggleCharging = function(){
      state.charging_state = !state.charging_state
      postDrive()
    };
